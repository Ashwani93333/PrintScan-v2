      ...
      <div className="max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="bg-surface-dark border border-border rounded-2xl p-8 md:p-12 shadow-xl prose prose-invert max-w-none">
          <div className="flex flex-col md:flex-row justify-between items-start mb-8">
            <div>
              <h1 className="text-3xl font-serif font-extrabold text-text-primary mb-2 mt-0">Privacy Policy</h1>
          ...
          <h3 className="text-lg font-semibold text-text-primary mt-6 mb-3">2.1 Information you provide directly</h3>
          ...
          {/* <h3 className="text-lg font-semibold text-text-primary mt-6 mb-3">2.3 Information from third parties</h3>
          ...
          <h2 className="text-xl font-bold text-text-primary mt-8 mb-4">4. How We Store and Protect Your Information</h2>
          <ul className="list-disc pl-5 text-muted mb-6 space-y-2">
          ...
          <h2 className="text-xl font-bold text-text-primary mt-8 mb-4">5. File Retention and Deletion</h2>
          <ul className="list-disc pl-5 text-muted mb-8 space-y-2">
          ...
          <h2 className="text-xl font-bold text-text-primary mt-8 mb-4">6. Who We Share Information With</h2>
          ...
          {/* <h2 className="text-xl font-bold text-text-primary mt-8 mb-4">7. Cookies</h2>
          <p className="text-muted mb-4 leading-relaxed">
          ...
          <div className="overflow-x-auto mb-6 border border-border rounded-lg">
            <table className="min-w-full divide-y divide-border text-sm text-left">
              <thead className="bg-surface-ink text-text-primary">
                <tr>
          ...
          <h2 className="text-xl font-bold text-text-primary mt-8 mb-4">7. Your Rights and Choices</h2>
          ...
          {/* <h2 className="text-xl font-bold text-text-primary mt-8 mb-4">10. International Users</h2>
          <p className="text-muted mb-8 leading-relaxed">
          ...
          <h2 className="text-xl font-bold text-text-primary mt-8 mb-4">8. Data Breach Notification</h2>
          <p className="text-muted mb-8 leading-relaxed">
          ...
          {/* <h2 className="text-xl font-bold text-text-primary mt-8 mb-4">12. Third-Party Links</h2>
          <p className="text-muted mb-8 leading-relaxed">
          ...
          <h2 className="text-xl font-bold text-text-primary mt-8 mb-4">9. Changes to This Policy</h2>
          <p className="text-muted mb-8 leading-relaxed">
          ...
          <h2 className="text-xl font-bold text-text-primary mt-8 mb-4">10. Contact Us</h2>
          <p className="text-muted mb-8 leading-relaxed">
